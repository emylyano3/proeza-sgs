/* Sistema */
	...
	insert into sgs_proeza_db.sys_item(id, codigo, texto, tooltip, link, icono) values (4, 'MI_ARTI', 'Artículo', 'Para acceder al home de articlo','#', 'fa fa-barcode');
	insert into sgs_proeza_db.sys_item(id, codigo, texto, tooltip, link, icono) values (5, 'MI_ARTI_HOME', 'Home', 'Para acceder al home de articlo','/articulo/home', 'fa fa-home');
	insert into sgs_proeza_db.sys_item(id, codigo, texto, tooltip, link, icono) values (6, 'MI_ARTI_LIST', 'Listado', 'Para acceder al listado de articulos','/articulo/listado', 'fa fa-list');

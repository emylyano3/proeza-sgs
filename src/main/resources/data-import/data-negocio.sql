...
/* Data de negocio */
	...
	insert into sgs_proeza_db.cmn_movimiento (id, tipo_mov, fk_entidad, tipo_entidad, f_movimiento, valor_ant, valor_post) values (99, 'MOD_PRECIO', 1, 'ARTICULO', '02/15/2015', '250', '270');
